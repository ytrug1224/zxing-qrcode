package com.uzxing.lib.activity;
...
import com.uzxing.lib.R;
import com.uzxing.lib.camera.CameraManager;
import com.uzxing.lib.decoding.CaptureActivityHandler;
import com.uzxing.lib.decoding.InActivityTimer;
import com.uzxing.lib.view.ViewfinderView;
...
public class CaptureFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mViewfinder = (ViewfinderView) view.findViewById(R.id.viewfinder_view);
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        if (mHandler == null) {
            mHandler = new CaptureActivityHandler(this, decodeFormats, characterSet, mViewfinder);
        }
    }
